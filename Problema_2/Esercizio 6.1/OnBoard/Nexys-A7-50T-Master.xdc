...
create_clock -period 100000.000 -name sys_clk_pin -waveform {0.000 5.000} -add [get_ports CLK]
...
set_property -dict {PACKAGE_PIN V11 IOSTANDARD LVCMOS33} [get_ports led_out]
...
set_property -dict {PACKAGE_PIN P17 IOSTANDARD LVCMOS33} [get_ports READ]
